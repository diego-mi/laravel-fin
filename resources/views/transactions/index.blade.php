            ...
            <table class="table">
                ...
                @foreach ($transactions as $transaction)
                    <tr>
                        ...
                        <td><span class="label label-success">{{ $transaction->category->title }}</span></td>
                        <td><span class="label label-success">{{ $transaction->source->title }}</span></td>
                        <td>{{ date('M j, Y', strtotime($transaction->created_at)) }}</td>
                        <td><a href="{{ route('transacao.show', $transaction->id) }}" class="btn btn-default btn-sm">Visualizar</a>
